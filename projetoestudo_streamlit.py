...
from colab_compat import files
...
# ============================================================
# ADAPTAÇÃO STREAMLIT - RESULTADO DA LEITURA DA MATRIZ
# ============================================================
if os.environ.get("AP360_MODO_LEITURA") == "1":
    resultado_leitura = {
        "operadora_atual": estado.get("operadora_atual"),
        "operadoras_disponiveis": list(estado.get("operadoras_disponiveis", [])),
    }
    with open("ap360_cenarios.json", "w", encoding="utf-8") as arquivo_resultado:
        json.dump(resultado_leitura, arquivo_resultado, ensure_ascii=False, indent=2)
    raise SystemExit(0)
...
entrada = os.environ.get("CENARIOS_SELECIONADOS", "").strip()

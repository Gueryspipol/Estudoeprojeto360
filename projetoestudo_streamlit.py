...
# ============================================================
# MODO STREAMLIT - SOMENTE IDENTIFICAR CENÁRIOS
# ============================================================
if os.environ.get("SCAN_ONLY") == "1":
    resultado_scan = {
        "operadora_atual": estado.get("operadora_atual"),
        "operadoras_disponiveis": estado.get("operadoras_disponiveis", []),
    }
    with open("cenarios_encontrados.json", "w", encoding="utf-8") as arquivo_scan:
        json.dump(resultado_scan, arquivo_scan, ensure_ascii=False, indent=2)
    raise SystemExit(0)

# -*- coding: utf-8 -*-
"""Apresentador 360 V2 - versão para execução local/GitHub.

Os arquivos de entrada podem ser informados por argumentos de linha de
comando ou digitados quando o programa for executado.
"""
...
def obter_arquivo(caminho, mensagem):
    """Retorna um caminho existente; se não informado, solicita ao usuário."""
    caminho = caminho or input(mensagem).strip()
    if not caminho:
...
parser = argparse.ArgumentParser(description="Apresentador 360 V2")
parser.add_argument("--matriz", help="Caminho do Excel da matriz (.xlsx)")
parser.add_argument("--modelo", help="Caminho do Excel Alimentador (.xlsx)")
parser.add_argument("--ppt", help="Caminho do PowerPoint modelo (.pptx)")
...
estado["arquivo_matriz"] = obter_arquivo(
    args.matriz,
    "Informe o caminho do Excel da matriz (.xlsx): "
)
...
arquivo_modelo = obter_arquivo(
    args.modelo,
    "Informe o caminho do Excel Alimentador (.xlsx): "
)

if not arquivo_modelo.lower().endswith(".xlsx"):
    raise ValueError("O arquivo Alimentador precisa ser .xlsx.")
...
ARQUIVO_PPT = obter_arquivo(args.ppt, "Informe o caminho do PowerPoint modelo (.pptx): ")
...
print("\nArquivo final gerado pelo projeto.")
